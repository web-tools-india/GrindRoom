CREATE OR REPLACE FUNCTION public.complete_session(p_session_id uuid, p_completed boolean)
RETURNS TABLE (
  session_id uuid,
...
GRANT EXECUTE ON FUNCTION public.complete_session(uuid, boolean) TO authenticated;
